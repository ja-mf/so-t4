...
public class ControlPanel extends Frame
{
    ...
    public void init( Kernel useKernel , String commands , String config )
    {
        ...
        Label lowLabel = new Label("startAddr: " , Label.LEFT) ;
        lowLabel.setBounds(285,210+25,110,15);
        add(lowLabel);

        Label highLabel = new Label("endAddr: " , Label.LEFT) ;
    ...
    public void paintPage(Page page, int currentTime)
    {
        virtualPageValueLabel.setText(Integer.toString(page.getPageID()));

        physicalPageValueLabel.setText(page.loaded() ?
                                       Integer.toString(page.getFrameID()) : "not loaded");

        RValueLabel.setText(page.getRStat());
        MValueLabel.setText(page.getMStat());
        inMemTimeValueLabel.setText(page.getInMemStat(currentTime));
        lastTouchTimeValueLabel.setText(page.getLastTouchStat(currentTime));

        lowValueLabel.setText(Long.toString(page.getStartAddr(), Kernel.addressradix));
        highValueLabel.setText(Long.toString(page.getEndAddr(), Kernel.addressradix));
    }
    ...
    public void addFrame(int pageNum , int physicalPage)
    {
        if ( physicalPage == 0 )
        {
            l0.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 1)
        {
            l1.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 2)
        {
            l2.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 3)
        {
            l3.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 4)
        {
            l4.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 5)
        {
            l5.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 6)
        {
            l6.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 7)
        {
            l7.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 8)
        {
            l8.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 9)
        {
            l9.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 10)
        {
            l10.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 11)
        {
            l11.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 12)
        {
            l12.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 13)
        {
            l13.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 14)
        {
            l14.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 15)
        {
            l15.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 16)
        {
            l16.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 17)
        {
            l17.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 18)
        {
            l18.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 19)
        {
            l19.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 20)
        {
            l20.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 21)
        {
            l21.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 22)
        {
            l22.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 23)
        {
            l23.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 24)
        {
            l24.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 25)
        {
            l25.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 26)
        {
            l26.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 27)
        {
            l27.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 28)
        {
            l28.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 29)
        {
            l29.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 30)
        {
            l30.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 31)
        {
            l31.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 32)
        {
            l32.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 33)
        {
            l33.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 34)
        {
            l34.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 35)
        {
            l35.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 36)
        {
            l36.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 37)
        {
            l37.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 38)
        {
            l38.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 39)
        {
            l39.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 40)
        {
            l40.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 41)
        {
            l41.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 42)
        {
            l42.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 43)
        {
            l43.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 44)
        {
            l44.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 45)
        {
            l45.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 46)
        {
            l46.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 47)
        {
            l47.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 48)
        {
            l48.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 49)
        {
            l49.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 50)
        {
            l50.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 51)
        {
            l51.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 52)
        {
            l52.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 53)
        {
            l53.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 54)
        {
            l54.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 55)
        {
            l55.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 56)
        {
            l56.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 57)
        {
            l57.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 58)
        {
            l58.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 59)
        {
            l59.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 60)
        {
            l60.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 61)
        {
            l61.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 62)
        {
            l62.setText( "frame " + pageNum );
        }
        else if ( physicalPage == 63)
        {
            l63.setText( "frame " + pageNum );
        }
        else
        {
            return;
    ...
    public void removeFrame(int physicalPage)
    {
        if ( physicalPage == 0 )
        {
            l0.setText( null );
